...
public class DomesticMetalAPIActivity extends Activity implements APICallback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTianjin = forceCast(findViewById(R.id.btnTianjin));
        btnGuangdong = forceCast(findViewById(R.id.btnGuangdong));
        btnNanfang = forceCast(findViewById(R.id.btnNanfang));
    ...
    private void showSpotResult(ArrayList<Map<String, Object>> result) {
        SimpleAdapter adapter = new SimpleAdapter(this, result, R.layout.view_domestic_metal_list_item,
                new String[]{"name", "highPic", "limit", "diffAmo", "lowPic", "openPri", "time", "buyPic", "sellPic", "closePri", "totalTurnover", "totalVol", "yesDayPic", "variety"},
                new int[]{R.id.tvName, R.id.tvHighPic, R.id.tvLimit, R.id.tvDiffAmo, R.id.tvLowPic, R.id.tvOpenPri, R.id.tvTime, R.id.tvBuyPic, R.id.tvSellPic, R.id.tvClosePri, R.id.tvTotalTurnover, R.id.tvTotalVol, R.id.tvYesterdayPic, R.id.tvVariety});
