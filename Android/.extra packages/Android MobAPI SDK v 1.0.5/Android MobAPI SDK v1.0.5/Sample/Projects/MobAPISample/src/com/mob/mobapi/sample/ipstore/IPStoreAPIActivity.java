...
public class IPStoreAPIActivity extends Activity implements OnClickListener, APICallback {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		etIPAddrNumber = forceCast(findViewById(R.id.etIPAddr));
		tvIpaddr   = forceCast(findViewById(R.id.tvIPAddr));
		tvCountry  = forceCast(findViewById(R.id.tvCountry));
	...
	public void onClick(View v) {
		IPStore api = forceCast(MobAPI.getAPI(IPStore.NAME));
	...
	public void onSuccess(API api, int action, Map<String, Object> result) {
		...
		tvIpaddr.setText(com.mob.tools.utils.R.toString(res.get("ip")));
		tvCountry.setText(com.mob.tools.utils.R.toString(res.get("country")));
		tvProvince.setText(com.mob.tools.utils.R.toString(res.get("province")));
		tvCity.setText(com.mob.tools.utils.R.toString(res.get("city")));
		tvDistrict.setText(com.mob.tools.utils.R.toString(res.get("district")));
	}
