...
public class SliverAPIActivity extends Activity implements APICallback, View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.btnFuture) {
            ...
            //查询期货黄金
            ((Sliver) forceCast(MobAPI.getAPI(Sliver.NAME))).queryFuture(this);
        } else {
            tvTittle.setText(R.string.sliver_api_title_spot);
            //查询现货黄金
            ((Sliver) forceCast(MobAPI.getAPI(Sliver.NAME))).querySpot(this);
        }
    }
