...
import com.mob.mobapi.sample.ucache.UcacheAPIActivity;
...
public class MainActivity extends Activity implements OnClickListener {
	private static final String APPKEY = "f3f22af901c0";
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
			...
			case R.id.btnStationAPI: startActivity(new Intent(this, StationAPIActivity.class)); break;
			case R.id.btnIDCardAPI: startActivity(new Intent(this, IDCardAPIActivity.class)); break;
			case R.id.btnEnvironmentAPI: startActivity(new Intent(this, EnvironmentAPIActivity.class)); break;
			case R.id.btnIPStoreAPI: startActivity(new Intent(this, IPStoreAPIActivity.class)); break;
			case R.id.btnUcacheAPI: startActivity(new Intent(this, UcacheAPIActivity.class)); break;
			case R.id.btnMobileLuckyAPI: startActivity(new Intent(this, MobileLuckyAPIActivity.class)); break;
			case R.id.btnBankCardAPI: startActivity(new Intent(this, BankCardAPIActivity.class)); break;
			case R.id.btnCalendarAPI: startActivity(new Intent(this, CalendarAPIActivity.class)); break;
			case R.id.btnLaoHuangLiAPI: startActivity(new Intent(this, LaoHuangLiAPIActivity.class)); break;
			case R.id.btnHealthAPI: startActivity(new Intent(this, HealthAPIActivity.class)); break;
			case R.id.btnMarriageAPI: startActivity(new Intent(this, MarriageAPIActivity.class)); break;
			case R.id.btnHistoryAPI: startActivity(new Intent(this, HistoryAPIActivity.class)); break;
			case R.id.btnDreamAPI: startActivity(new Intent(this, DreamAPIActivity.class)); break;
			case R.id.btnIdiomAPI: startActivity(new Intent(this, IdiomAPIActivity.class)); break;
			case R.id.btnDictionaryAPI: startActivity(new Intent(this, DictionaryAPIActivity.class)); break;
			case R.id.btnHoroscopeAPI: startActivity(new Intent(this, HoroscopeAPIActivity.class)); break;
			case R.id.btnOilPriceApi: startActivity(new Intent(this, OilPriceAPIActivity.class)); break;
			case R.id.btnLotteryApi: startActivity(new Intent(this, LotteryAPIActivity.class)); break;
			case R.id.btnWxArticleApi: startActivity(new Intent(this, WxArticleAPIActivity.class)); break;
			case R.id.btnBoxOfficeApi: startActivity(new Intent(this, BoxOfficeAPIActivity.class)); break;
			case R.id.btnGoldApi: startActivity(new Intent(this, GoldAPIActivity.class)); break;
			case R.id.btnExchangeApi: startActivity(new Intent(this, ExchangeAPIActivity.class)); break;
			case R.id.btnGlobalStockApi: startActivity(new Intent(this, GlobalStockListAPIActivity.class)); break;
			case R.id.btnUserCenterApi: startActivity(new Intent(this, UserCenterAPIActivity.class)); break;
			case R.id.btnSliverApi: startActivity(new Intent(this, SliverAPIActivity.class)); break;
			case R.id.btnDomesticMetalApi: startActivity(new Intent(this, DomesticMetalAPIActivity.class)); break;
			case R.id.btnIKTokenApi: startActivity(new Intent(this, IKTokenAPIActivity.class)); break;
			case R.id.btnTrainTicketsApi: startActivity(new Intent(this, TrainTicketsAPIActivity.class)); break;
			case R.id.btnFlightApi: startActivity(new Intent(this, FlightAPIActivity.class)); break;
		}
	}
