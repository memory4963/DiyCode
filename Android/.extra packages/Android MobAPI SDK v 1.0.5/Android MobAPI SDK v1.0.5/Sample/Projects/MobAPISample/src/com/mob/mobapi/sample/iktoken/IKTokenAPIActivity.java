...
public class IKTokenAPIActivity extends Activity implements APICallback, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etText = forceCast(findViewById(R.id.etText));
        tvResultTitle = forceCast(findViewById(R.id.tvResultTitle));
        tvResult = forceCast(findViewById(R.id.tvResult));

        GridView gvCategory = forceCast(findViewById(R.id.gvCategory));
        gvCategory.setOnItemClickListener(this);

        categoryList = new ArrayList<HashMap<String, String>>();
        categoryAdapter = new SimpleAdapter(this, categoryList, android.R.layout.simple_list_item_1, new String[]{"desc"}, new int[]{android.R.id.text1});
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        isQuerying = true;
        tvResult.setText("");
        HashMap<String, String> item = forceCast(categoryAdapter.getItem(position));
    ...
    public void onSuccess(API api, int action, Map<String, Object> result) {
        switch (action) {
            case IKToken.ACTION_CATEGORY:
                ArrayList<HashMap<String, String>> tmpList = forceCast(result.get("result"));
