...
public class GlobalStockDetailActivity extends ListActivity implements APICallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HashMap<String, Object> itemData = forceCast(getIntent().getSerializableExtra("item"));
        if (itemData == null) {
            return;
        }
        type = (Integer) itemData.get("type");
        GlobalStock api = forceCast(MobAPI.getAPI(GlobalStock.NAME));
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup viewGroup) {
            ...
            if (itemData != null && !itemData.isEmpty()) {
                if (convertView == null) {
                    convertView = LayoutInflater.from(GlobalStockDetailActivity.this).inflate(R.layout.view_globalstock_detail_item, viewGroup, false);
                    ...
                    viewHolder.tvContinent = forceCast(convertView.findViewById(R.id.tvContinent));
                    viewHolder.tvCountry = forceCast(convertView.findViewById(R.id.tvCountry));
                    viewHolder.tvName = forceCast(convertView.findViewById(R.id.tvName));
                    viewHolder.tvCode = forceCast(convertView.findViewById(R.id.tvCode));
                    viewHolder.tvChange = forceCast(convertView.findViewById(R.id.tvChange));
                    viewHolder.tvChangeRate = forceCast(convertView.findViewById(R.id.tvChangeRate));
                    viewHolder.tvPrice = forceCast(convertView.findViewById(R.id.tvPrice));
                    viewHolder.tvTime = forceCast(convertView.findViewById(R.id.tvTime));
                ...
                if (itemData.get("changeRate") != null) {
                    ...
                    viewHolder.tvChangeRate.setText(getString(R.string.globalstock_api_item_change_rate) + " " + itemData.get("changeRate").toString());
                }
